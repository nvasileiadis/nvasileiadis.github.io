...
image: /assets/social-cards/diagram-capability.jpg
date: 2026-09-11 10:00:00 +0000
categories: leadership
description: "A restructuring proposal would have folded our design system team into mine. I argued against my own reinforcement, with diagrams instead of complaints, and the return took two years to appear on anyone's books. On political capital, blast radius, and why a well-drawn picture wins arguments."
---

Midway through the hardest restructuring of my career, a proposal crossed my desk that would have made my team bigger. The design systems team - a handful of people maintaining the component library, design tokens, and UI standards that twenty-plus engineering teams build on - was to be folded into mine. On paper I was the winner: more headcount, more scope, one less dependency to negotiate with.
...
Nobody proposing it was careless or hostile, and the intent was never destruction. It was reallocation, and a reasonable-looking one: fold the boxes together, and the specialists' time could flex towards the visible product roadmap, with design-system work becoming something to commission when a plan called for it. Work whose value is invisible gets reclassified as optional; that is the whole mechanism, and it operates in every organisation I know of. My private prediction was that the work would gradually be deprioritised until the day the company needed its entire estate to move at once - and then we would be rebuilding exactly what we had folded away.

What the chart couldn't show was the web. Twenty-plus teams consumed those components daily. Every customer touchpoint shared one visual language because it was defined in exactly one place. Accessibility and brand standards were enforced once, not re-derived twenty times. And none of the fragmentation was hypothetical: some teams had already built their own components to their own rules, and the design systems team was midway through the slow, diplomatic work of bringing them back onto the shared library. Folding the team away wouldn't make the demand go away - it would remove the centre, and give up ground against fragmentation that was already half-won.

There was a second thing the chart couldn't show: the machinery inside the boxes. The absorbed team wasn't four interchangeable engineers. It was two specialists whose skills split down the middle - only one worked across both web and native - a player-coach lead already carrying design and product duties at once, and a dedicated senior UX designer, with more UX capacity flexing in as the component work grew. Merge that into a team that already had its own product manager and its own full roadmap, and the collisions write themselves: two people holding one steering wheel, specialists redirected onto work that fits neither their skills nor their appetite, designers left with an irregular trickle of work. The tidy box was, on inspection, a box that wouldn't have worked as drawn - and "this merged team will not function" is an argument you can make from the org chart's own contents.

The fair objection, before I go further - I'd raise it myself: every manager is certain that the capability under threat on *their* watch is load-bearing, and most of them are wrong. Survivorship bias writes a lot of essays like this one. Two answers. First, load-bearing is testable, not felt: the [four-characteristic test from the soft platforms post](/leadership/2026/08/28/soft-platforms-why-horizontal-work-dies-inside-product-verticals.html) - horizontal reach, service model, BAU-dominant, invisible when working - and the design system passed all four with a dependency list anyone could audit. Second, check the incentives: I was arguing against my own enlargement. When the manager who would collect the headcount says the merge destroys value, that is at least worth a longer meeting.
...
The first instalment arrived about eighteen months later, when the company rebranded. The 522-page website I've written about before was only one surface. The rebrand had to move through every service journey, two mobile apps, a partner-facing portal, account management, and the campaign tooling wrapped around all of it - and that breadth is exactly what a design system is for. Because a single, coherent component library existed - one the preserved team went on to build after the proposal was set aside - rebranding meant updating one source of truth and propagating it across every surface, rather than renegotiating the brand separately with every system that renders it. The website slice alone shipped in two quarters, on the critical path for every team's launch. Priced against the folded-team counterfactual - the scramble my prediction promised - the same programme reads as years, a small army of contractors, and a brand that never quite converges.

The second instalment landed nearly two years after the argument: the preserved team's documented engineering work registered as a substantial financial return on the company's books. The point isn't the amount; it's that the return was real money, produced by a capability that had once been a box somebody proposed folding away.

Here is the uncomfortable truth those two instalments taught me: neither was attributed to the defence, and there was no reason they would be. No retrospective, in any organisation, connects a rebrand's speed or a line on the books to a meeting two years earlier - the causal chain is too long and too quiet. Returns on structure are real, late, and unattributed - and if you need attribution before you'll spend political capital, you will never spend it, and load-bearing things will keep getting folded away on your watch.

<figure>
  <img src="/assets/images/posts/capability-defence/payback-timeline.svg" alt="A timeline. Day zero: the argument - political capital spent, nothing to show. A long quiet stretch labelled invisible on every ledger. At eighteen months: the rebrand ships - every surface on one source of truth. At around two years: the financial postscript - substantial, and finally on the books." width="880" height="270" loading="lazy">
...
*This is part of an occasional series on engineering leadership under real-world pressure. Earlier posts: [What 100% Team Retention Through Three Restructurings Actually Looks Like](/leadership/2026/07/31/what-100-percent-retention-actually-looks-like.html), [Archaeology: How to Inherit a System Nobody Documented](/leadership/2026/08/21/archeology-inheriting-a-system-nobody-documented.html), [Ten Vendors, One Contract](/leadership/2026/08/24/ten-vendors-one-contract-vendor-evaluation-as-engineering-leadership.html), and [Soft Platforms: Why Horizontal Work Dies Inside Product Verticals](/leadership/2026/08/28/soft-platforms-why-horizontal-work-dies-inside-product-verticals.html). Find me on [LinkedIn](https://www.linkedin.com/in/nvasileiadis).*
