...
image: /assets/social-cards/soft-platforms.jpg
...
*This is part of an occasional series on engineering leadership under real-world pressure. Earlier posts: [What 100% Team Retention Through Three Restructurings Actually Looks Like](/leadership/2026/07/31/what-100-percent-retention-actually-looks-like.html), on keeping a team through the upheaval that produced this one, and [Archaeology: How to Inherit a System Nobody Documented](/leadership/2026/08/21/archeology-inheriting-a-system-nobody-documented.html), on turning an undocumented inheritance into an asset. Find me on [LinkedIn](https://www.linkedin.com/in/nvasileiadis).*
