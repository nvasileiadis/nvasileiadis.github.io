...
- **Platform Reliability & Analytics Ownership:** Maintained <span class="stat">100% uptime</span> on uw.co.uk (SLO: 99.99%) with <span class="stat">&lt;3s</span> page load times on critical-path pages and ≤2 incidents per year, all resolved within hours. Supported <span class="stat">15</span> dependent teams across Customer Marketing, Digital Marketing, Partner Marketing, Acquisition, Data Science, Recruitment, and more. Owns the full platform analytics and compliance stack: Contentful CMS, Google Tag Manager, Snowplow, Mixpanel, Optimizely, and OneTrust — <span class="stat">six platform services</span> monitored via Kubernetes, Sentry, Prometheus, Pingdom, and Cloudflare.
