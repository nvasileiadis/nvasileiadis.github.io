...
nav_title: CV
permalink: /cv/
description: "CV of Nikos Vasileiadis — Engineering Leader with 20+ years of continuous engineering and 9 years of dual-tracked leadership. Engineering Manager at Utility Warehouse. Expertise in platform architecture, Design Systems, Agile transformation, and commercial engineering. Open to Head of Engineering and VP Engineering roles in the UK."
...
- **Cross-Functional Technical Vision**: Bridging the gap between product strategy, UX, and technical execution — backed by <span class="stat">20+ years</span> of continuous engineering and <span class="stat">9 years</span> of dual-tracked leadership, maintaining hands-on technical depth throughout every leadership role.

## About

Strategic engineering leader with <span class="stat">20+ years</span> of continuous engineering experience and <span class="stat">9 years</span> of progressive leadership — dual-tracking both since 2017. Unlike most managers, I never stopped writing code. From rotating Scrum Master duties at Jadu while shipping CMS features, to introducing Agile at Leeds Building Society as a hands-on senior developer, to running Scrum at IMA-HOME while engineering frontends for Adidas and MARS — every leadership step was taken without leaving the codebase behind. At Utility Warehouse, I was hired explicitly to both write code and build a team from scratch. Today, under significant resource constraints, I operate as Engineering Manager, Product Manager, and Individual Contributor simultaneously — absorbing three roles to keep my teams delivering.

I treat engineering as a business lever — contributing to CapEx/OpEx planning, evaluating vendor ROI, and ensuring technical investments map directly to business outcomes. My leadership arc has grown continuously since 2017: from rotating Scrum Master roles at Jadu and Leeds Building Society, to bootstrapping and leading the Content Capability team at Utility Warehouse, to my current Engineering Manager role overseeing two teams and <span class="stat">eight engineers</span> — each step a deliberate expansion of scope, and each one an added layer of responsibility on top of the technical work I never set down.
...
- **Triple-Hatting Under Constraints (2025–Present):** With the team significantly under-resourced and under pressure to deliver, absorbed Product Manager and IC responsibilities alongside Engineering Management — driving delivery across three roles simultaneously while maintaining <span class="stat">100% team retention</span>, platform stability, and strategic programme execution. A continuation of the dual-track approach that has defined my career since 2017.
